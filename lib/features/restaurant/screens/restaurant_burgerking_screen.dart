...
class RestaurantBurgerkingScreen extends StatefulWidget {
  const RestaurantBurgerkingScreen({super.key});

  @override
  State<RestaurantBurgerkingScreen> createState() =>
      _RestaurantBurgerkingScreenState();
}

class _RestaurantBurgerkingScreenState
    extends State<RestaurantBurgerkingScreen> {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => FoodDetailScreen(
                          ...
                          'Burger King',
                          restaurantImage:
                          'assets/Images/burgerking_logo.png',
                        ),
                      ),
                    );
                  },
