...
class RestaurantKfcScreen extends StatefulWidget {
  const RestaurantKfcScreen({super.key});

  @override
  State<RestaurantKfcScreen> createState() => _RestaurantKfcScreenState();
}

class _RestaurantKfcScreenState extends State<RestaurantKfcScreen> {
  ...
  final List<Map<String, dynamic>> reviewsData = [
    {
      ...
      'rating': 5.0,
      'text':
          "What can I say it's fast food, it's KFC. No different to any of the other KFCs, nice with adequate seating",
      'likes': 68,
      'images': [],
    },
    {
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => FoodDetailScreen(
                          foodItem: item,
                          restaurantName: 'KFC',
                          restaurantImage: 'assets/Images/kfc_logo.png',
                        ),
                      ),
                    );
                  },
                      ...
                      ValueListenableBuilder<Set<String>>(
                        ...
                        builder: (context, favoriteIds, child) {
                          final bool isFavorite =
                              FavoritesManager.isFavorite('KFC', item['name']!);
                          return IconButton(
                            icon: Icon(
