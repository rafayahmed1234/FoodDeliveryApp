...
class RestaurantTacobellScreen extends StatefulWidget {
  const RestaurantTacobellScreen({super.key});

  @override
  State<RestaurantTacobellScreen> createState() =>
      _RestaurantTacobellScreenState();
}

class _RestaurantTacobellScreenState extends State<RestaurantTacobellScreen> {
  ...
  final List<Map<String, dynamic>> reviewsData = [
    {
      ...
      'rating': 5.0,
      'text':
          "What can I say it's fast food, it's Tacobell. No different to any of the other Tacobells, nice with adequate seating",
      'likes': 68,
      'images': [],
    },
    {
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              _buildDotSeparator(),
                              _buildInfoBadge(
                                  icon: Icons.access_time, text: '20 Mins'),
                              _buildDotSeparator(),
                              _buildInfoBadge(
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => FoodDetailScreen(
                          ...
                          restaurantImage: 'assets/Images/tacobell_logo.png',
                        ),
                      ),
                    );
                  },
